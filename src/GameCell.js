...
export default class GameCell extends React.Component {
    ...
    constructor(props) {
        ...
        // Binds function so that it can use this.state and this.props internall
    ...
    // handleBeep - causes beep if player selects game cell already chosen
    handleBeep(e) {
    ...
    render() {
        ...
        if (this.props.value === 0)
            return <div className="game-cel"onClick={this.handleBeep}>O</div>;
        else if (this.props.value === 1)
            return <div className="game-cel" onClick={this.handleBeep}>X</div>;
        ...
        // Render cell that cannot be selected -- end game conditions
            ...
            return <div className="game-cel" onClick={this.handleBeep}>-</div>;
    }
